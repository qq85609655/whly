...
import com.thinkgem.jeesite.modules.sys.service.AccountService;
...
public class UserController extends BaseController {
	...
	public String accountIndex(Account user, Model model) {
		 model.addAttribute("user", user);
		return "modules/sys/accountIndex";
	}
	@RequiresPermissions("sys:user:view")
	@RequestMapping(value = {"accountList", ""})
	public String accountList(Account user, HttpServletRequest request, HttpServletResponse response, 
			Model model,String userName,String nickName
			) {
		if(user==null){
			user=new Account();
		}
		...
		Page<Account> page = accountService.findAccount(new Page<Account>(request, response), user);
        model.addAttribute("page", page);
		return "modules/sys/accountList";
	}
	
	/*@ResponseBody
	@RequiresPermissions("sys:user:view")
	@RequestMapping(value = {"accountListData"})
	public Page<User> accountListData(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<User> page = systemService.findUser(new Page<User>(request, response), user);
		return page;
	}*/
