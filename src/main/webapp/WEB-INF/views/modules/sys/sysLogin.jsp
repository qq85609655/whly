...
<body>
	...
	<h1 class="form-signin-heading">译见后台管理系统</h1>
	...
	<div class="footer">
		Copyright &copy; 2017<a href="#">译见后台管理系统</a> - Powered By <a href="#" >hlsofttech</a> ${fns:getConfig('version')} 
	</div>
