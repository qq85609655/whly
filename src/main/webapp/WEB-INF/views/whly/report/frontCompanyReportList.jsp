			...
			<div class="page-content">
				...
				<div class="portlet-body">
					<form:form id="searchForm" modelAttribute="frontCompanyReport"
						...
						<div class="row">
							<div class="form-group col-md-4 type_emphasis type_quota"
								style="display: none;">
								<label class="control-label col-md-4 "
									style="padding: 6px 12px;">行业：</label>
								<div class="col-md-8">
							...
							<div class="form-group col-md-4 type_support"
								style="display: none;">
								<label class="control-label col-md-4 "
									style="padding: 6px 12px;">项目名称：</label>
								<div class="col-md-8">
									<input class="form-control" type="text" placeholder=""
										name="projectName" value="${front.projectName }"
										id="projectNameQuery">
								</div>
							</div>
							<div class="form-group col-md-4">
								...
								<div class="col-md-8">
									<input class="form-control" type="text" placeholder=""
										name="companyName" value="${front.companyName }"
										id="nameQuery">
								</div>
							</div>
							<div class="form-group col-md-4">
								<button class="btn demo-loading-btn green col-md-3" id="query"
									onclick="loadingCancel('query')" type="submit"
									style="margin-left: 15px;">检索</button>
								<div class="col-md-1"></div>
								<button class="btn green demo-loading-btn col-md-3"
									type="button" id="export" onclick="loadingCancel('export')">导出</button>
								<div class="col-md-1"></div>
								<button class="btn green demo-loading-btn col-md-3" id="reset"
									type="button" onclick="loadingCancel('reset')">重置</button>
							</div>
						</div>
					</form:form>
				</div>
									...
									<tbody>
										<c:forEach items="${page.list}" var="frontCompanyReport">
											<tr class="gradeX odd" role="row">
												...
												<td class="type_emphasis " style="display: none;">${frontCompanyReport.currentInvestment}</td>
