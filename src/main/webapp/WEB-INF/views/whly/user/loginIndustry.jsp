...
<%@ page import="com.thinkgem.jeesite.modules.sys.security.WhlyIndustryFormAuthenticationFilter"%>
...
@media screen and (min-width:1400px) and (max-width:2000px) {
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form id="loginForm" class="form-signin" action="${whlyPath}/industry/login" method="post">
